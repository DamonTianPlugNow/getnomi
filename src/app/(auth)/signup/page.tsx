    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 p-4 bg-[#f7f6f3] rounded-lg">
          <p className="text-sm font-medium text-[#37352f] mb-3">What you get:</p>
          <div className="space-y-2">
            {[
              'AI-powered personal context',
              'Portable .md file export',
              'Smart matching with others',
            ].map((benefit, i) => (
        ...
        <p className="mt-6 text-center text-sm text-[#37352f]/60">
          ...
          <Link href="/login" className="text-[#0077cc] hover:underline font-medium">
            Log in
          </Link>
        </p>
