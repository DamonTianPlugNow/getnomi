...
### TD-7: Auth Callback 日志清理

- **What**: 移除或替换 `auth/callback/route.ts` 中的 console.log 为结构化日志
- **Why**: 当前日志在生产环境暴露 redirect URL，包括潜在的攻击尝试
- **Mitigation**: 使用统一的 logger，只在 development 环境输出详细信息
- **Severity**: LOW
